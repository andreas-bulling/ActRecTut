...
clear; % it's saver
evalType = {'pd', 'pi'};
classifiers ={'knnVoting', 'NaiveBayes', 'SVM','jointBoosting', 'cHMM', 'DA'};
mfilename
for ec =  evalType
    for iClassifier = classifiers
        ...
        for s =  [1 2]
            ...
            settings;
            SETTINGS = setClassifier(classifier, SETTINGS);
            ...
            % store results
            filename = saveExperiment(confusion, metrics, scoreEval, mfilename, [e classifier], SETTINGS);   
        end
    end
end